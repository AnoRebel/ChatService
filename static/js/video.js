...
function getRoom() {
  var stor = localStorage.getItem('access_token');
  return stor;
}

// Retrieve the absolute room URL.
function getRoomURL() {
  return location.protocol + "//" + location.host + "/main" + (location.path || "") + "?room=" + getRoom();
}
...
function enableVideo() {
  ...
  document.getElementById("enabvid").style.display = "none";
  loadSimpleWebRTC();
}
